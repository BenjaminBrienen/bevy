...
impl Plugin for RenderPlugin {
    ...
    fn build(&self, app: &mut App) {
        ...
        load_shader_library!(app, "../shaders/utils.wesl");
        load_shader_library!(app, "../shaders/view.wesl");
        load_shader_library!(app, "../shaders/maths.wesl");
        load_shader_library!(app, "../shaders/color_operations.wesl");
        load_shader_library!(app, "../shaders/bindless.wesl");
